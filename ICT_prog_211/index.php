...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="view.php"> Course IDs   </a>
              </li>
              <li class="nav-item dropdown">
                 ...
                 <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="#Course">Social Media Marketing</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#Course">Graphic designing</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#Courses">Wordpress</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#Courses">Search Engine Optimization</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#Course">Amazon Virtual assistant</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="#Courses">Autocad</a></li>
                 </ul>
              </li>
              <li class="nav-item">
            ...
            <li class="nav-item text-white">
                <a class="nav-link active" aria-current="page" href="log.php">LOG-IN</a>
              </li>
              <li class="nav-item text-white">
    ...
    <div class="p-1 mb-2 bg-primary text-white" width="100%" font-size="18px"><center><h4>Our Courses</h4></center></div>
    <br><br>
    <div  class="container">
      <div id ="Courses" class="row justify-content-evenly row-cols-3">
       <div class="col-md-3">
         <div class="card" >
           <img src="image/seo1.png" class="card-img-top" alt="...">
           <div class="card-body">
             <h5 class="card-title">Search Engine Optimization</h5>
             <p class="card-text">Sign-up/Log-In to get access to course content.</p>
             <a href="reg.php" class="btn btn-primary">Join course</a>
            </div>
         </div>
       </div>
       <div class="col-md-3">
         <div class="card">
           <img src="image/wp1.png" class="card-img-top" alt="...">
           <div class="card-body">
       ...
       <div class="col-md-3">
         <div class="card">
           <img src="image/autocad11.jpg" class="card-img-top" alt="...">
           <div class="card-body">
     ...
     <br><br>
     <div id ="Course" class="row justify-content-evenly row-cols-3">
       <div class="col-md-3">
         <div class="card">
           <img src="image/graphic1.png" class="card-img-top" alt="...">
           <div class="card-body">
       ...
       <div class="col-md-3">
         <div class="card">
           <img src="image/avs11.png" class="card-img-top" alt="...">
           <div class="card-body">
       ...
       <div class="col-md-3">
         <div class="card">
           <img src="image/dm11.jpg" class="card-img-top" alt="...">
           <div class="card-body">
   ...
   <div id="about" class="p-1 mb-2 bg-primary text-white" width="100%" font-size="18px"><center><h4>About us</h4></center></div>
   <br>
   <div  class="container">
   ...
   <br>
   <div class="p-1 mb-2 bg-primary text-white" width="100%" font-size="18px"><center><h4>Contact us</h4></center></div>
   <br>
   <div id="contact" class="container">
    ...
    ?>
      <form action="/ICT_prog_21/view.php" method="POST">
        <div class="row">
          <div class="col">
           <b>First name : </b><input type="text" name ="fnme" id="fnme" class="form-control" placeholder="First name" aria-label="fname" required>
         </div><br>
          <div class="col">
            <b>Last Name : </b><input type="text" name ="lnme" id="lnme" class="form-control" placeholder="Last name" aria-label="lname" required>
         </div>
       </div>
       <br><br>
       <div class="row">
         <div class="col">
           <b>Subject : </b><input type="text" name ="sub" id="sub" class="form-control" required placeholder="Subject" aria-label="Subject">
         </div><br>
         <div class="col">
            <b>Email : </b><input name ="email" id="email" type="email" class="form-control" required placeholder="Email Address" aria-label="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$">
         </div><br>
       </div>
       <br>
       <div class="row">
         <div class="col">
            <b>Message : </b><textarea name ="msg" id="msg" class="form-control" required placeholder="Enter your message" id="exampleFormControlTextarea1" rows="3"></textarea><br>
   ...
   <div class="pt-2 pb-1 mb-1 bg-primary text-white" width="100%" font-size="18px"><center><h4>Follow us :&nbsp&nbsp
